...
<nav class="navbar navbar-light bg-light">
  <form class="form-inline text-center">
    <input id="customer_id" readonly class="form-control-plaintext mr-sm-2" type="text" aria-label="Search" data-customer-id = "${customerId}"value="Customer ID: ${customerId}">
      	...
      	function search(){
      		...
      		$.ajax({
      	        ...
      	        success: function (data) {
      	        	var customer_id = $("#customer_id").data("customerId");
      	            ...
      	            roomList.forEach((room) => {
      	        	  ...
      	        	  "<div class=\"card-body\">"+
      	            			"<h5 class=\"card-title\">"+room.name+"</h5>"+
      	            		    "<p class=\"card-text\">$"+room.price+"/day</p>"+
      	            		    "<a href=\"frontServlet?command=StaffCheckOrder&&customer_id="+customer_id+"&&check_in_time="+check_in_time+"&&check_out_time="+check_out_time+"&&room_id="+room.roomId+"\" class=\"btn btn-primary\">Book</a>"+
      	            		    		"</div>"+
      	            		    		"</div>");
      	            });
      	        },
